...
<!-- <body > -->
  <div class="w-full bg-darkest rounded-tl-3xl rounded-tr-3xl relative z-50">
    <div class="p-10 grid grid-cols-fluid-15 gap-6">
      ...
      <div class="">
        <h4 class="text-2xl font-semibold text-white mb-[10px]">Support</h4>
        <p class="text-midGray">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Minus molestiae impedit ad consectetur soluta optio. Ad fugiat ea inventore facere</p>
        <div class="mt-[10px] text-white">
          <p class="">+233 222 333 444</p>
          <a href="#" class="underline">support@bliss.com</a>
        </div>
      </div>
