    ...
    <div class="mb-6">
        ...
        <div class="mb-6">
          <label for="" class="pb-4"> <span class="text-darkestGray">Email</span> <sup class="text-crimson text-lg ">*</sup></label>
             <input name="email" required class="w-full ring-2 ring-midGray rounded-full focus:outline-none focus:ring-2 focus:ring-primary py-3 px-6" maxlength="20" placeholder="Enter your email" oninput="this.value.replace(/\s/g,'') type="text">
          <div class="text-crimson text-center text-sm pt-1"></div>
        </div>  
        ...
        <div class="mb-6">
          <label for="" class="pb-4"> <span class="text-darkestGray">Select Profile</span> <sup class="text-crimson text-lg ">*</sup></label>
          <input name="image" class="w-full ring-2 ring-midGray rounded-full focus:outline-none focus:ring-2 focus:ring-primary py-3 px-6" type="file" name="image" accept="image/*" max="1048576">
          <div class="text-crimson text-center text-sm pt-1"></div>
        </div>  

        <button name="register" type="submit" class="btn-light">Submit<script src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/2.1.2/sweetalert.min.js" integrity="sha512-AA1Bzp5Q0K1KanKKmvN/4d3IRKVlv9PYgwFPvm32nPO6QS8yH1HO7LbgB1pgiOxPtfeg5zEn2ba64MUcqJx6CA==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
        </button>
      </div>
    </form>
